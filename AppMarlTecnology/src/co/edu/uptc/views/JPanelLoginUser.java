...
public class JPanelLoginUser extends JPanel {
	...
	public JPanelLoginUser(MainWindow mainWindow) {
	...
	private void initComponents() {
		...
		buttonInitSesion = new JButton(Constants.LABEL_INIT_USER);
		fuente = new Font("Arial", 0, 16);
		...
		buttonInitSesion.setActionCommand(Constants.LABEL_INIT_USER);
		...
		fuente = new Font("Arial", 0, 16);
		buttonRegistrer.setFont(fuente);
		buttonRegistrer.setBackground(Color.decode("#FE2542"));
		buttonRegistrer.setForeground(Color.decode("#D4FBF9"));
		gbc.gridx = 3;
		gbc.gridy = 11;
		gbc.gridheight = 1;
		gbc.gridwidth = 1;
		buttonRegistrer.setPreferredSize(new Dimension(200, 20));
		buttonRegistrer.setActionCommand(Constants.BUTTON_REGISTER);
		buttonRegistrer.addActionListener(mainWindow.getEvents());
		this.add(buttonRegistrer, gbc);
