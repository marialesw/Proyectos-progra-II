...
public class JPanelListFamilys extends JPanel implements ListSelectionListener{
   
    private JList listaProductos;

 
    public JPanelListFamilys(){
    ...
    public void initComponents(){
        ...
        panelListaYBotones.setBorder( new CompoundBorder( new EmptyBorder( 4, 3, 3, 3 ), new TitledBorder( "Familias" ) ) );
	...
	public void actualizarLista( List<Familia> list ){
